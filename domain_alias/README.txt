...
To create a new alias, go to the Domain List at Admin > Structure > Domains(/admin/structure/domain).
 click on edit domain of the desired domain. Click on "Aliases: tab". You should see the aliases on this page.
